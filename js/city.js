...
ProceduralCity	= function(){
	...
	const light	= new THREE.Color( 0xeeeeee )
	const shadow = new THREE.Color( 0x303050 )

	const cityGeometry = new THREE.Geometry();
	for( let i = 0; i < 20000; i ++ ){
		// put a random position
		buildingMesh.position.x	= Math.floor( Math.random() * 200 - 100 ) * 15;
		buildingMesh.position.z	= Math.floor( Math.random() * 200 - 100 ) * 15;
